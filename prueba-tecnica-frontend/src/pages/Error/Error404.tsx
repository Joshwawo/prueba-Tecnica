...
const Error404 = () => {
  ...
  return (
    <div className="h-screen">
      <div className="  bg-[#FFFFFFDE]  flex items-center mt-32 xl:mt-60">
        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700 mx-auto">
          <div className="max-w-md">
            ...
            <p className="mb-8 mt-2 ">
              Pero no se preocupe, puede encontrar muchas otras cosas en nuestra
              página web.
            </p>

            <Link
              to={`${auth.isAdmin ? '/inicio/maestros' : '/inicio/alumnos'}`}
              className="uppercase text-sm font-bold tracking-wide border  border-gray-300  p-3 rounded-lg w-full hover:bg-black hover:text-white  transition-colors duration-200"
            >
